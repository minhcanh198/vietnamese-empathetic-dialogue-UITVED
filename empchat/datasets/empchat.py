...
parser.add_argument('--bpe-codes',
                    default="/content/drive/My Drive/PhoBERT_EMPATHETICDIALOGUES/EmpatheticDialogues/PhoBert/PhoBERT_base_transformers/bpe.codes",
                    type=str)
...
class PhoBertTokenizer(object):
    def __init__(
        ...
        self.vocab.add_from_file("/content/drive/My Drive/PhoBERT_EMPATHETICDIALOGUES/EmpatheticDialogues/PhoBert/PhoBERT_base_transformers/dict.txt")
    ...
    def __init__(
        ...
        if fasttext is not None:
            ...
            if hasattr(dic, "bert_tokenizer"):
                ...
                #     ),
                # )
                new_tokenizer = PhoBertTokenizer()
                # assert new_tokenizer.vocab.keys() == dic.bert_tokenizer.vocab.keys()
                assert new_tokenizer.vocab.symbols == dic.bert_tokenizer.vocab.symbols
